...
class NHLScreen():
    def __init__(self):
        ...
        self.matrix = MATRIX
        self.color = graphics.Color(DEFAULT_FONT_COLOR[0], DEFAULT_FONT_COLOR[1], DEFAULT_FONT_COLOR[2])
    ...
    def drawUpcomingGamesScreen(self, team):
        ...
        for game in games:
            ...
            # draw team names
            graphics.DrawText(offscreen_canvas, font, x, y+30, team_color, home_team.get_name())
